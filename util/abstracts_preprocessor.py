...
class AbstractsPreprocessor(object):
    ...
    """
    def __init__(self, n_item, word_to_count, article_to_word, article_to_word_to_count):
        """
        ...
        :param int n_item: the number of items in the dataset
        """
        self.abstracts = None
    ...
    def get_term_frequency_sparse_matrix(self):
        ...
        n_words = self.get_num_vocab()
        return sparse.coo_matrix((counts, (articles, words)),
                                 shape=(self.n_item, n_words)).tocsr()
